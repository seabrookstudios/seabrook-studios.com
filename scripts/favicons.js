...
const source = "src/images/icon.png"; // Source image(s). `string`, `buffer` or array of `string`

const configuration = {
  path: "/", // Path for overriding default icons path. `string`
  appName: "Seabrook Studios", // Your application's name. `string`
  appShortName: null, // Your application's short_name. `string`. Optional. If not set, appName will be used
  appDescription: null, // Your application's description. `string`
  developerName: "Seabrook Studios", // Your (or your developer's) name. `string`
  developerURL: "seabrook-studios.com", // Your (or your developer's) URL. `string`
