...
export const games = [
  {
    ...
    sku: "SBSTT01",
    hook: "Build the nicest town and grab the best buildings before they flow over the edge!",
    ctaLink: "https://shop.seabrook-studios.com/products/timber-town",
    ctaText: "Buy",
    tags: ["game"],
    players: "2",
    age: "10+",
    ...
    artist: "Isabelle Overturf",
    bggLink: "https://boardgamegeek.com/boardgame/436561/timber-town",
    blurb: [],
    images: [BoxShots.SBSTT01],
    availableForRetail: true,
    components: [],
    barcode: "",
    weight: 800,
    caseCount: 6,
    dimensions: "230x230x40mm",
    msrpAUD: 50,
    moreInfoLink: "/games/timber-town",
    year: "2025",
  },
  {
    slug: "18-holes",
